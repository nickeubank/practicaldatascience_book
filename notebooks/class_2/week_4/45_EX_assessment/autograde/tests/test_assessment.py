...
def test_filtering():
    assert np.isclose(solution.FILTERED_MEAN, assess.FILTERED_MEAN), "FILTERED_MEAN is incorrect"
    assert np.isclose(solution.FILTERED_MEDIAN, assess.FILTERED_MEDIAN), "FILTERED_MEDIAN is incorrect"