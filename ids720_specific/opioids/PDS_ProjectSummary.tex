...
In the spirit of this class, this is REAL DATA, and you should NOT assume it's perfectly clean and ready for use.
...
\begin{itemize}
  ...
  \item \href{https://github.com/wpinvestigative/arcos-api/blob/master/data/data_dictionary.csv}{You can find more about variables in the data here,} and \href{https://arcos.nd.edu/definitions}{some additional documentation here}. \emph{Hint:} I'm not giving you these resources for no data.
\end{itemize}
