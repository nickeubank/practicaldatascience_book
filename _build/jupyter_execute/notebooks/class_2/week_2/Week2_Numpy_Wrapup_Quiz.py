...
# 
# To estimate the effective such a policy on inequality, first calculate the total amount of money that would be generated by this tax if the households in this data were all households in the US. Round your answer to one decimal place.
#   
...
# 
# What is the resulting Gini Index of `Policy D`?
