...
For this project, you will be provided a dataset with the total amount of opioid shipments per county per year for this period. You can also find more documentation about the raw data (before it was collapsed to the county-year level) \href{https://github.com/wpinvestigative/arcos-api/blob/master/data/data_dictionary.csv}{here}.
